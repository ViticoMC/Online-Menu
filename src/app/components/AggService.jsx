...
export default function AgregarService() {
  ...
  const { setIsAggService } = useAdminStore();
  ...
  const handleSubmit = async (e) => {
    ...
    const { error } = await supabase
      .from("services")
      .insert({ image : imageFile, name: formData.name, price: formData.price, description: formData.descripción })
      setIsAggService(false);
